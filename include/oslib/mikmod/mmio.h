...
extern void StringWrite(CHAR *s, VIRTUAL_FILE *fp);
extern CHAR *StringRead(VIRTUAL_FILE *fp);
...
#define _mm_write_SBYTE(x,y)    VirtualFilePutc((int)x,y)
#define _mm_write_UBYTE(x,y)    VirtualFilePutc((int)x,y)

#define _mm_read_SBYTE(x) (SBYTE)_mm_fgetc(x)
#define _mm_read_UBYTE(x) (UBYTE)_mm_fgetc(x)

#define _mm_write_SBYTES(x,y,z)  VirtualFileWrite((void *)x,1,y,z)
#define _mm_write_UBYTES(x,y,z)  VirtualFileWrite((void *)x,1,y,z)
#define _mm_read_SBYTES(x,y,z)   _mm_fread((void *)x,1,y,z)
#define _mm_read_UBYTES(x,y,z)   _mm_fread((void *)x,1,y,z)

#define _mm_rewind(x) _mm_fseek(x,0,SEEK_SET)


extern int  _mm_fseek(VIRTUAL_FILE *stream, long offset, int whence);
extern long _mm_iobase_get(void);
extern void _mm_iobase_set(long iobase);
extern void _mm_iobase_setcur(VIRTUAL_FILE *fp);
extern void _mm_iobase_revert(void);
extern long _mm_ftell(VIRTUAL_FILE *stream);
extern long _mm_flength(VIRTUAL_FILE *stream);
extern VIRTUAL_FILE *_mm_fopen(CHAR *fname, CHAR *attrib);
extern int _mm_fclose(VIRTUAL_FILE *fp);
extern int _mm_feof(VIRTUAL_FILE *fp);
extern void _mm_fputs(VIRTUAL_FILE *fp, CHAR *data);
extern BOOL _mm_copyfile(VIRTUAL_FILE *fpi, VIRTUAL_FILE *fpo, ULONG len);
extern void _mm_write_string(CHAR *data, VIRTUAL_FILE *fp);
extern int  _mm_read_string (CHAR *buffer, int number, VIRTUAL_FILE *fp);


/*extern SBYTE _mm_read_SBYTE (VIRTUAL_FILE *fp); */
/*extern UBYTE _mm_read_UBYTE (VIRTUAL_FILE *fp); */

extern SWORD _mm_read_M_SWORD (VIRTUAL_FILE *fp);
extern SWORD _mm_read_I_SWORD (VIRTUAL_FILE *fp);

extern UWORD _mm_read_M_UWORD (VIRTUAL_FILE *fp);
extern UWORD _mm_read_I_UWORD (VIRTUAL_FILE *fp);

extern SLONG _mm_read_M_SLONG (VIRTUAL_FILE *fp);
extern SLONG _mm_read_I_SLONG (VIRTUAL_FILE *fp);

extern ULONG _mm_read_M_ULONG (VIRTUAL_FILE *fp);
extern ULONG _mm_read_I_ULONG (VIRTUAL_FILE *fp);


/*extern int _mm_read_SBYTES    (SBYTE *buffer, int number, VIRTUAL_FILE *fp); */
/*extern int _mm_read_UBYTES    (UBYTE *buffer, int number, VIRTUAL_FILE *fp); */

extern int _mm_read_M_SWORDS  (SWORD *buffer, int number, VIRTUAL_FILE *fp);
extern int _mm_read_I_SWORDS  (SWORD *buffer, int number, VIRTUAL_FILE *fp);

extern int _mm_read_M_UWORDS  (UWORD *buffer, int number, VIRTUAL_FILE *fp);
extern int _mm_read_I_UWORDS  (UWORD *buffer, int number, VIRTUAL_FILE *fp);

extern int _mm_read_M_SLONGS  (SLONG *buffer, int number, VIRTUAL_FILE *fp);
extern int _mm_read_I_SLONGS  (SLONG *buffer, int number, VIRTUAL_FILE *fp);

extern int _mm_read_M_ULONGS  (ULONG *buffer, int number, VIRTUAL_FILE *fp);
extern int _mm_read_I_ULONGS  (ULONG *buffer, int number, VIRTUAL_FILE *fp);


/*extern void _mm_write_SBYTE     (SBYTE data, VIRTUAL_FILE *fp); */
/*extern void _mm_write_UBYTE     (UBYTE data, VIRTUAL_FILE *fp); */

extern void _mm_write_M_SWORD   (SWORD data, VIRTUAL_FILE *fp);
extern void _mm_write_I_SWORD   (SWORD data, VIRTUAL_FILE *fp);

extern void _mm_write_M_UWORD   (UWORD data, VIRTUAL_FILE *fp);
extern void _mm_write_I_UWORD   (UWORD data, VIRTUAL_FILE *fp);

extern void _mm_write_M_SLONG   (SLONG data, VIRTUAL_FILE *fp);
extern void _mm_write_I_SLONG   (SLONG data, VIRTUAL_FILE *fp);

extern void _mm_write_M_ULONG   (ULONG data, VIRTUAL_FILE *fp);
extern void _mm_write_I_ULONG   (ULONG data, VIRTUAL_FILE *fp);

/*extern void _mm_write_SBYTES    (SBYTE *data, int number, VIRTUAL_FILE *fp); */
/*extern void _mm_write_UBYTES    (UBYTE *data, int number, VIRTUAL_FILE *fp); */

extern void _mm_write_M_SWORDS  (SWORD *data, int number, VIRTUAL_FILE *fp);
extern void _mm_write_I_SWORDS  (SWORD *data, int number, VIRTUAL_FILE *fp);

extern void _mm_write_M_UWORDS  (UWORD *data, int number, VIRTUAL_FILE *fp);
extern void _mm_write_I_UWORDS  (UWORD *data, int number, VIRTUAL_FILE *fp);

extern void _mm_write_M_SLONGS  (SLONG *data, int number, VIRTUAL_FILE *fp);
extern void _mm_write_I_SLONGS  (SLONG *data, int number, VIRTUAL_FILE *fp);

extern void _mm_write_M_ULONGS  (ULONG *data, int number, VIRTUAL_FILE *fp);
extern void _mm_write_I_ULONGS  (ULONG *data, int number, VIRTUAL_FILE *fp);
