...
extern SAMPLOAD *SL_RegisterSample(SAMPLE *s, int type, VIRTUAL_FILE *fp);    /* Returns 1 on error! */
...
{   struct MDRIVER *next;
    ...
    BOOL    (*IsPresent)          (void);
    SWORD   (*SampleLoad)         (SAMPLOAD *s, int type, VIRTUAL_FILE *fp);
...
extern SWORD  MD_SampleLoad(SAMPLOAD *s, int type, VIRTUAL_FILE *fp);
...
extern MDRIVER drv_psp;      /* PSP driver */
...
/* extern SWORD   VC_SampleLoad(SAMPLOAD *sload, int type, VIRTUAL_FILE *fp); */
...
extern SWORD   VC2_SampleLoad(SAMPLOAD *sload, int type, VIRTUAL_FILE *fp);
